...
def plot_farm_layout(farm):
    ...
    position_Lat_long = get_lat_long('/Users/ashely/PyWake/Project 4/turbine_layout/Seagreen_TBL.geojson')
...
def geoJson_coordinates_data(farm_name, continent):
    ...
    if continent == 'europe':
        europe = 'europe'
        filepath = os.path.join('/Users/ashely/PyWake/Project 4/USA/Seagreen.geojson',europe)
    
    elif continent == 'usa':
        usa = 'usa'
        filepath = os.path.join('/Users/ashely/PyWake/Project 4/turbine_layout/Seagreen_TBL.geojson',usa)

    filepath1 = os.path.join('/Users/ashely/PyWake/Project 4/USA/Seagreen.geojson')
